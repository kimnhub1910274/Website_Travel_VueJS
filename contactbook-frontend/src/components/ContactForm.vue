<template>
    ...
    >
        ...
        <div class="row">
            <div class="form-group col-8">
            <label for="img2"><b>Hình ảnh 2</b></label>
                <Field
                    name="img2"
                    type="file"
                    class="form-control"
        ...
        <div class="row">
            <div class="form-group col-8">
            <label for="img3"><b>Hình ảnh 3</b></label>
                <Field
                    name="img3"
                    type="file"
                    class="form-control"
                    v-model="contactLocal.img3"
                    ref="file"
                    @change="selectImage"
                />
                <ErrorMessage name="img3" class="error-feedback" />
            </div>
            
        </div>
        <div class="form-group">
            <label for="description3"><b>Mô tả 3</b></label>
                <Field
                    name="description3"
                    type="text"
                    class="form-control"
                    v-model="contactLocal.description3"
                />
                <ErrorMessage name="description3" class="error-feedback" />
        </div>
        <div v-if="currentImage" class="progress">
            <div
                class="progress-bar progress-bar-info"
        ...
        <div class="row">
            <div class="form-group col-8">
            <label for="img4"><b>Hình ảnh 4</b></label>
                <Field
                    name="img4"
                    type="file"
                    class="form-control"
                    v-model="contactLocal.img4"
                    ref="file"
                    @change="selectImage"
                />
                <ErrorMessage name="img4" class="error-feedback" />
            </div>
            
        </div>
        <div class="form-group">
            <label for="description4"><b>Mô tả 4</b></label>
                <Field
                    name="description4"
                    type="text"
                    class="form-control"
                    v-model="contactLocal.description4"
                />
                <ErrorMessage name="description4" class="error-feedback" />
        </div>
        <div v-if="currentImage" class="progress">
            <div
                class="progress-bar progress-bar-info"
